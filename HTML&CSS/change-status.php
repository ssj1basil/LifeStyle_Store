    ...
    <div class="container table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                $get_items_query = "SELECT users_items.item_id,items.name,items.price,users_items.Quantity,users_items.status,users_items.id FROM users_items INNER JOIN items ON users_items.item_id= items.id 
                WHERE items.Supplier_id='$supplier_id' AND users_items.status='Confirmed'";     
                ...
                if ($total_rows > 0) {
                    for ($row = 0; $row < $total_rows; $row++) {
                        ...
                        echo "<td><a href='confirm-delivery.php?id={$row_info[5]}'>Deliver Order</a></td>";
                        echo "</tr>";
